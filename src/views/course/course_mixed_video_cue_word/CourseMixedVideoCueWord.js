...
import {
    ...
    insertMixedVideoCueWordAPI,
    updateMixedVideoCueWordAPI,
    deleteMixedVideoCueWordAPI,
...
export default function Index(props) {
  ...
  const getAllReading = (id) => {
    ...
    setConversationCueWordStates({ conversationCueWordStates });
    getAllMixedVideoCueWordByCueAPI(id, conversationCueWordStates.token)
      .then((res) => {
  ...
  const insertListeningData = (values) => {
      ...
      insertMixedVideoCueWordAPI(values, conversationCueWordStates.token)
        .then((res) => {
            conversationCueWordStates.loader = false;
            setConversationCueWordStates({conversationCueWordStates});
            if (res && res.data && res.data.status && res.data.status === true) {
                ...
                setConversationCueWordStates({ ...conversationCueWordStates });
                getAllReading(props.courseIds.mixedVideoCueId);
  ...
  const updateListeningData = (values) => {
      conversationCueWordStates.loader = true;
      setConversationCueWordStates({conversationCueWordStates})
      updateMixedVideoCueWordAPI(values, conversationCueWordStates.token)
        .then((res) => {
            conversationCueWordStates.loader = false;
            setConversationCueWordStates({conversationCueWordStates});
            if (res && res.data && res.data.status && res.data.status === true) {
  ...
  const deleteListeningData = (values) => {
      conversationCueWordStates.loader = true; 
      setConversationCueWordStates({conversationCueWordStates})
      deleteMixedVideoCueWordAPI(values.id, conversationCueWordStates.token)
        .then((res) => {
            conversationCueWordStates.loader = false;
            setConversationCueWordStates({conversationCueWordStates})
            if (res && res.data && res.data.status && res.data.status === true) {
  ...
  const onFinishWriting = (values) => {
      ...
      if (conversationCueWordStates.action == "ADD_READING") {
        //   values.is_active = parseInt(values.is_active);
          var insObj = {
              cue_id : parseInt(props.courseIds.mixedVideoCueId),
